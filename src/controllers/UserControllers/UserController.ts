import { getAuthToken, getToken } from './../../middlewares/checkJwt';
...
export class UserController {
    ...
    static register = async (req: Request, res: Response) => {
        try {
            ...
            else if (err.code === 404) res.status(409).send({ error: true, message: 'Le mot de passe doit comporter au moins 8 caractéres dont au moins un majuscule, un chiffre et un caractére spécial' });
